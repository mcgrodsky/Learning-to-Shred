...
$( document ).ready(function() {
  ...
  $(".fretboard").on('change', 'input', function (e) {
    // when an input is changed, update the list of pressed notes and show the updated list
    clearOthersInRow(this);
    showSelected();
  });
  function showSelected() {
    // output a list of strings being pressed (for convenience in appending to chords array)
    var sel = getSelected();
    $("#selected").val(sel.length?"'"+sel.join("','")+"'":'');
  }
  function getSelected() {
    // get the array of notes being pressed
    var sel = [];
  ...
  function clearOthersInRow(selected) {
    // ensure `selected` is the only note being pressed on this string
...
//     $div.append($input);
//
//     // use id again to connect for and id
//     var $label = $("<label for='"+id+"'></label>");
//
//     $div.append($input);
//     $div.append($label);
